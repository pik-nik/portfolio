    ...
    return (
        <div className="py-16 px-4 h-screen flex justify-center relative text-center">
            <div className="flex overflow-hidden relative flex-col text-lft md:flex-row max-w-full max-h-[80vh] px-10 justify-evenly mx-auto">
                <h1 className="text-primary absolute top-16 uppercase tracking-[10px] text-2xl">
                    Projects
                </h1>
                <div className="w-full flex-shrink-0 flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory mt-20 scrollbar scrollbar-track-tertiary/80 scrollbar-thumb-primary/80 scrollbar-thin">
                    <ProjectCard />
                    <ProjectCard />
                    <ProjectCard />
                </div>
