    ...
    return (
        <div className="group relative flex flex-col cursor-pointer justify-center rounded-2xl border-2 border-tertiary dark:border-primary_dark hover:border-secondary dark:hover:border-secondary_dark dark:bg-text_dark/20 object-contain items-center">
            ...
            <Image
                ...
                width="200"
                height="200"
                className="p-3 object-over w-20 h-20 md:w-28 md:h-28 2xl:h-40 2xl:w-40 filter group-hover:opacity-[20%] transition duration-300 ease-in-out group-hover:scale-110"
            />
            <div className="absolute opacity-0 group-hover:opacity-100 transition duration-300 ease-in-out group-hover:scale-110 items-center h-full font-sans font-bold text-center flex">
