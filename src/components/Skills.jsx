...
function Skills({ skills }) {
    return (
        <div className="py-16 px-4 flex relative flex-col text-center md:text-left xl:px-10 justify-center h-fit md:min-h-screen md:max-h-fit xl:space-y-0 mx-auto items-center">
